        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobShiftPreferred = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CertifiedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TillTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Salary = table.Column<double>(type: "float", nullable: true),
                    PreferredGender = table.Column<int>(type: "int", nullable: true),
                    PreferredYearsOfExperience = table.Column<int>(type: "int", nullable: true),
                    HasOnlineTest = table.Column<bool>(type: "bit", nullable: false),
                    ApprovedAverage = table.Column<float>(type: "real", nullable: true),
                    HasTestInSite = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FinishedTest = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobApplicantLifecycles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobApplicantLifecycles_JobApplicants_JobApplicantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobQuestionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobQuestionAnswers", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "JobApplicantAnswers",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ApplicantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    JobQuestionAnswerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsCorrect = table.Column<bool>(type: "bit", nullable: false),
                    JobId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobApplicantAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobApplicantAnswers_Applicants_ApplicantId",
                        column: x => x.ApplicantId,
                        principalTable: "Applicants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobApplicantAnswers_JobQuestionAnswers_JobQuestionAnswerId",
                        column: x => x.JobQuestionAnswerId,
                        principalTable: "JobQuestionAnswers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobApplicantAnswers_ApplicantId",
                table: "JobApplicantAnswers",
                column: "ApplicantId");

            migrationBuilder.CreateIndex(
                name: "IX_JobApplicantAnswers_JobQuestionAnswerId",
                table: "JobApplicantAnswers",
                column: "JobQuestionAnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_JobApplicantLifecycles_JobApplicantId",
                table: "JobApplicantLifecycles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobQuestionAnswers_JobQuestionId",
